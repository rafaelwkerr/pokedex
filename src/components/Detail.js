...
export default function Detail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
        ...
        //setSpecie(pokemonSpecie.flavor_text_entries);
        
        //setFrontImg(pokemonData.sprites.front_default);
        //setBackImg(pokemonData.sprites.back_default);
  ...
  const urlImg = `https://assets.pokemon.com/assets/cms2/img/pokedex/full/00${pokemon.id}.png`;
